...
{
    public partial class PMCReport : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (DropDownReport.SelectedItem.Text != "--Select--")
                {
                    ...
                    else if (DropDownReport.SelectedItem.Text == "Response Time")
                    {
                        MyReportViewer.ServerReport.ReportPath = "/TSD-Performance/PMC-Response-KPI";
                        ReportParameter[] reportParameterCollection = new ReportParameter[8];       //Array size describes the number of paramaters.
