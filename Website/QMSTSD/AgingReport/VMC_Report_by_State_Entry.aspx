<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VMC_Report_by_State_Entry.aspx.cs" Inherits="AgingReport.VMC_Report_by_State" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="height: 255px">
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <asp:Label ID="Label30" runat="server" Font-Bold="True" Font-Italic="False" Font-Names="Calibri" Font-Size="Large" Text="Enter VCM Report Data" Width="300px" style="text-align: center"></asp:Label>               
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
            &nbsp;
            &nbsp;&nbsp;&nbsp;
              <table style="margin-left:auto; align="center"  margin-right:auto">
                    ...
                    <tr>
                     ...
                     <td>
                         <asp:DropDownList ID="DropDownState" OnSelectedIndexChanged="DropDownState_SelectedIndexChanged" runat="server" Visible="true" Width="200" Height="25" BackColor="White" DataTextField="ast_lvl_ast_lvl" DataValueField="RowID" AutoPostBack="True" ></asp:DropDownList>
                     </td>
                    ...
                    <tr>
                     <td>
                          ...
                          <asp:Label ID="Label7" runat="server" Text="District" Font-Names="Calibri"  Font-Bold="false" Width="150" Height="25"> </asp:Label>
                     </td>
                     <td>
                         <asp:DropDownList ID="DropDownDistrict"  runat="server" Visible="true" Width="200" Height="25" BackColor="White" DataTextField="ast_loc_ast_loc" DataValueField="RowID" AutoPostBack="True" ></asp:DropDownList>
                     </td>
                  ...
                  <tr>
                     ...
                     <td>
                          <asp:DropDownList ID="DropDownYear" runat="server" Visible="true"   Width="200" Height="25" BackColor="White" DataTextField="year" DataValueField="year" AutoPostBack="True" ></asp:DropDownList>
                     </td>
                  </tr>
                   <tr>
                       <td>
          ...
          <asp:DropDownList ID="DropDownCliniccat"  ToolTip="Type here to search" CssClass="form-control js-example-placeholder-single" runat="server" AutoPostBack="true" BackColor="White" OnSelectedIndexChanged="DropDownCliniccat_SelectedIndexChanged" DataTextField="Cliniccat" DataValueField="RowID" Width="200" Height="25"></asp:DropDownList>
                    ...
                    <tr>
                     <td>
                          ...
                          <asp:Label ID="Label1" runat="server" Text="Response Time Penalty" Font-Names="Calibri"  Font-Bold="false" Width="150" Height="25"> </asp:Label>
                     </td>
                     <td>
                  ...
                  <tr>
                      ...
                      <td>
                           <asp:Label ID="lab" runat="server" Text="Repair Time Penalty" Font-Names="Calibri"  Font-Bold="false" Width="150" Height="25"> </asp:Label>
                     </td>
                     <td>
                    ...
                    <tr>
                     <td>
                          ...
                          <asp:Label ID="Label6" runat="server" Text="Preventive Maintenance Penalty" Font-Names="Calibri"  Font-Bold="false" Width="150" Height="25"> </asp:Label>
                     </td>
                     <td>
