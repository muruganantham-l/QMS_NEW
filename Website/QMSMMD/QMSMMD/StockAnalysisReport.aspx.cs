...
namespace QMSMMD
{
    public partial class StockAnalysisReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    string com = "select ast_lvl_ast_lvl, ast_lvl_desc from ast_lvl (nolock)";
                    ...
                    string com1 = "Select ast_grp_grp_cd , ast_grp_category from ast_grp (Nolock) order by ast_grp_category";
                    ...
                    Category.DataBind();
                    Category.DataTextField = "ast_grp_category";
                    ...
                    string com3 = "select sup_mst_supplier_cd, sup_mst_desc from sup_mst (nolock) order by sup_mst_desc ";

                    SqlDataAdapter adpt3 = new SqlDataAdapter(com3, con);
                    DataTable dt3 = new DataTable();
                    adpt3.Fill(dt2);
                    Supplier.DataSource = dt3;
                    Supplier.DataBind();
                    Supplier.DataTextField = "sup_mst_desc";
                    Supplier.DataValueField = "sup_mst_supplier_cd";
                    Supplier.DataBind();
                    Supplier.Items.Insert(0, new ListItem("ALL", "0"));
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            string supplier = Supplier.SelectedItem.Value;
            string stockno = Manafacturer.SelectedItem.Value;
            string beno = DropDownState.SelectedItem.Text;
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("exec SP_Stockanalysis_Report_out '" + DropDownState.SelectedItem.Text + "' , '" + startdate + "' , '" + enddate + "' , '" + status + "' , '" + supplier + "' , '" + stockno + "' , '" + beno + "'", con);
