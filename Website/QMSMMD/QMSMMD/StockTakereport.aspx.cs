...
namespace QMSMMD
{
    public partial class StockTakereport : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("exec SP_Stocktake_Report_out '" + DropDownState.SelectedItem.Value + "' , '" + startdate + "' , '" + enddate  + "'", con);
        ...
        {
            String strfilename = "Stock Take Report ";
            string startdate = TextBox1.Text;
            string enddate = TextBox2.Text;
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                hw.WriteLine("<b><font size='5'>" +
                            "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; STOCKTAKE REPORT (FROM " + startdate + "  TO  " + enddate + ")         &nbsp;&nbsp;&nbsp;&nbsp;  DATE :" + DateTime.Now.ToString("yyyy-MM-dd") +
                            "</font></b>"+
                            "</br>");
                hw.WriteLine("<br>");
                hw.WriteLine("<br>");
