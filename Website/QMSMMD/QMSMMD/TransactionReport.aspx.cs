...
namespace QMSMMD
{
    public partial class TransactionReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    /*For Transaction Dropdown Load*/
                    string com1 = "select TransType,TransTypedesc from inv_transaction_type (nolock)";

                    SqlDataAdapter adpt1 = new SqlDataAdapter(com1, con);
                    DataTable dt1 = new DataTable();
                    adpt1.Fill(dt1);
                    TransType.DataSource = dt1;
                    TransType.DataBind();
                    TransType.DataTextField = "TransTypedesc";
                    TransType.DataValueField = "TransType";
                    TransType.DataBind();
                    TransType.Items.Insert(0, new ListItem("--Select--", "0"));
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            string trans = TransType.SelectedItem.Text;
            ...
            if (trans != "--Select--")
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("exec Sp_inventory_trans_Report_out '" + DropDownState.SelectedItem.Text + "' , '" + DropDownList1.SelectedItem.Text + "' , '" + startdate + "' , '" + enddate + "' , '" + trans +"'", con);
            ...
            if (trans != "--Select--")
            {
                ...
                using (StringWriter sw = new StringWriter())
                {
                    ...
                    hw.WriteLine("<b><font size='5'>" +
                                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "+strfilename+" (FROM " + startdate + "  TO  " + enddate + ")         &nbsp;&nbsp;&nbsp;&nbsp;  DATE :" + DateTime.Now.ToString("yyyy-MM-dd") +
                                "</font></b>" +
                                "</br>");
                    hw.WriteLine("<br>");
                    hw.WriteLine("<br>");
