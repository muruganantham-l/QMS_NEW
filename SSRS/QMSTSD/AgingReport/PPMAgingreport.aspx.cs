...
{
    public partial class PPMAgingreport : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("exec SP_ppm_Ageing_Report_out '" + DropDownState.SelectedItem.Text + "','" +
                DropDownDistrict.SelectedItem.Text + "','" + DropDowncircle.SelectedItem.Text + "','" + DropDownCliniccat.SelectedItem.Text + "','" +
                DropDownBECate.SelectedItem.Value + "','" + DropDownOwner.SelectedItem.Text + "','" + TextBox1.Text + "','" + TextBox2.Text + "' , '" + DropDownList1.SelectedItem.Value + "'", con);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            String strfilename = "PPM Aging Report ";
