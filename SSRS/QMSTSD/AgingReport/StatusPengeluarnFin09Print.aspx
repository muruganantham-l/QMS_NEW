...
<body>
      ...
      <td>
            ...
            <asp:DropDownList ID="DropDownReportname" ToolTip="Type here to search" CssClass="form-control js-example-placeholder-single"  runat="server" Visible="true" Width="200" Height="25" BackColor="White" DataTextField="ast_det_modelno" DataValueField="ast_det_modelno" AutoPostBack="True"   ></asp:DropDownList>
                    ...
                    <tr>
                     ...
                     <td></td>
                       <td></td>
                     <td><asp:Button ID="print" runat="server" Height="33px" Text="Generate" Width="134px"  onclick="print_Click"  /> </td>
                     <td></td>
                       <td></td>
 ...
 <td align="center" colspan="6">   
  ...
  <rsweb:ReportViewer ID="MyReportViewer" runat="server" Width="1200" Height="1500" PageCountMode="Actual" ShowRefreshButton="False" ShowFindControls="False" ShowPrintButton="true" ShowParameterPrompts="false" ShowPromptAreaButton="false">
            </rsweb:ReportViewer> 
 </td>
              </tr>
            </table>
