<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PRAgingReport.aspx.cs" Inherits="AgingReport.PRAgingReport" %>
...
<ItemStyle Width="5%"></ItemStyle>
                        ...
                        <asp:BoundField DataField="PR DATE" HeaderText="PR DATE" SortExpression="PR DATE" ItemStyle-Width="10%" Visible="true" >
<ItemStyle Width="10%"></ItemStyle>
                        </asp:BoundField>
