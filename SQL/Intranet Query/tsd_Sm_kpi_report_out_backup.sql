...
@cliniccategory	varchar(100)= null,
@periodfrom	date = '2018-08-01',
@periodto	date = '2018-08-30',
...
,CEILING(CAST(DateDiff(minute, wko_mst_org_date, isnull(wko_det.wko_det_cmpl_date,Getdate())) AS DECIMAL(14, 5)) / 60 / 24)
,CEILING(CAST(DateDiff(minute, wko_mst_org_date, isnull(wko_det.wko_det_cmpl_date,Getdate())) AS DECIMAL(14, 5)) / 60 / 24)
,''
,dbo.[state_noofholidays](ast_mst.ast_mst_ast_lvl,wko_mst_org_date,isnull(wko_det_cmpl_date,getdate()))
,0
,1
,0
,''
