Create Procedure Notif_High_Penalty_equip_sp
as
begin

	Declare @Email_code varchar(200), 
			@Zm_email_code varchar(200)
...
',
	...
	FETCH NEXT FROM cursor_name INTO @Email_code,@Zm_email_code  
        END  
